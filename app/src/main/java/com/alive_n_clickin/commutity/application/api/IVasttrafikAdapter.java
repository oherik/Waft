...
public interface IVasttrafikAdapter {
      ...
      */
     List<IStop> getNearbyStations(double longitude, double latitude);
      ...
      * empty list is returned.
      */
     List<IStop> getSearchStops(String searchString);
     ...
     */
     List<IArrivingVehicle> getVehiclesHeadedToStop(IStop stop);
}
